(function () {
  ...
  (self["webpackChunkuserapp"] = self["webpackChunkuserapp"] || []).push([["src_app_folder_folder_module_ts"], {
    /***/
    10917:
    /*!*******************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _report_seller_report_seller_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var _FolderPage = /*#__PURE__*/function () {
        ...
        _createClass(FolderPage, [{
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      return this.popoverController.create({
                        component: _report_seller_report_seller_component__WEBPACK_IMPORTED_MODULE_3__.ReportSellerComponent,
          ...
          key: "singleCard",
          value: function singleCard() {
            this.isvisible = true;
          }
        }, {
          key: "storeDetails",
          value: function storeDetails() {
          ...
          value: function ProductList() {
            ...
            this.http.get('/product_list').subscribe(function (response) {
              _this3.productlist = response.records;
          ...
          value: function clickSlide(item) {
            ...
            if (this.activeItem == "home") {} else {
              this.activeItem = item;
            }

            return;
            this.http.post('/list_product', '').subscribe(function (response) {
              _this4.productlist = response.records;
      ...
      _FolderPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
        selector: 'app-folder',
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".card {\n  border: 1px solid #FFFFFF;\n  border-radius: 3px;\n  box-shadow: 4px 4px 4px 4px #ccc;\n  margin-bottom: 20px;\n  margin-right: 4px;\n  cursor: pointer;\n}\n\n#social-media-icon-div {\n  border: 1px solid #FFFFFF;\n  border-radius: 8px;\n  box-shadow: 4px 4px 4px 4px #ccc;\n}\n\np {\n  padding: 0 !important;\n  margin: 0 !important;\n}\n\n#offer {\n  padding: 2px !important;\n  margin: 5px !important;\n}\n\n.report-seller-btn {\n  background: linear-gradient(to right, #ff80a0 0%, #eb154b 100%);\n  color: #fff;\n  margin-left: 10%;\n}\n\n#product_img {\n  border: 1px solid #FFFFFF;\n  border-radius: 15%;\n  box-shadow: 3px 3px 16px 4px #ccc;\n  width: 85px;\n  height: 75px;\n}\n\n#share {\n  color: #fff !important;\n}\n\n#kg {\n  background: linear-gradient(to left, #23a6d5 0%, #23d5ab 100%);\n  color: #fff;\n  margin-left: -15px !important;\n  border-radius: 3px !important;\n  font-size: 10px !important;\n  margin-top: 4px;\n}\n\n.dot {\n  height: 30px;\n  width: 30px;\n  background: linear-gradient(to left, #23a6d5 0%, #23d5ab 100%);\n  color: #fff;\n  border-radius: 50%;\n  display: inline-block;\n  box-shadow: 3px 3px 16px 4px #ccc;\n}\n\n#test {\n  border: 1px solid #fff;\n  box-shadow: 3px 3px 16px 4px #ccc;\n  margin-left: 8px !important;\n  margin-right: 6px !important;\n  margin: 6px;\n  width: 45%;\n  background-color: #fff !important;\n  border-radius: 2px;\n}\n\n#heart {\n  margin-left: -10px !important;\n  border-radius: 50% !important;\n  height: 20px;\n  width: 20px;\n}\n\n.green {\n  color: #404040 !important;\n}\n\n.red {\n  color: red !important;\n  border-radius: 55%;\n  padding: 2px;\n}\n\n.btn-default {\n  color: white;\n  background-color: blue;\n}\n\n.btn-change {\n  color: Red;\n  background-color: white;\n}\n\nion-chip.active {\n  color: red !important;\n  background: linear-gradient(to right, #555c59 0%, #1d1f1e 100%);\n}\n\nion-slides {\n  height: 50px !important;\n  padding-left: 15px;\n  padding-right: 15px;\n  margin-bottom: 15px;\n  background-color: #fff !important;\n}\n\n.featured-slide {\n  width: 50% !important;\n  border-radius: 10px;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n\n.featured-slide .info {\n  margin: 50px !important;\n  margin-left: 0 !important;\n  margin-right: 0px !important;\n  font-size: 17px !important;\n  color: #6E7989;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n\n.div-slides {\n  bottom: 0;\n  width: 100%;\n  display: block;\n  background-color: #e6e6e6;\n}\n\n.div-slides img {\n  margin: 10px;\n  margin-right: 2px !important;\n  border-radius: 75px;\n}\n\n.tam-title {\n  margin-top: -0.5%;\n  font-size: 80%;\n  font-weight: bold;\n  color: #6E7989;\n}\n\nion-slide {\n  margin-left: -20px !important;\n  margin-right: 23px !important;\n}\n\nion-badge {\n  z-index: 999 !important;\n}\n\n#slideItem.active {\n  color: #23d5ab;\n  font-weight: 700;\n}\n\nion-content {\n  background-color: #F4F7FA !important;\n  --offset-bottom: auto!important;\n  --overflow: hidden;\n  overflow: auto;\n}\n\nion-content::-webkit-scrollbar {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
