...
Icon.ɵfac = function Icon_Factory(t) { return new (t || Icon)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
Icon.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: Icon, selectors: [["ion-icon"]], hostAttrs: ["role", "img"], hostVars: 2, hostBindings: function Icon_HostBindings(rf, ctx) { if (rf & 2) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(Icon, [{
    ...
    }], function () { return [{ type: ɵngcc1.Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }]; }, { _hidden: [{
            type: HostBinding,
            args: ['class.hide']
        }], name: [{
            type: Input
