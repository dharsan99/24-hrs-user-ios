...
FabContainer.ɵfac = function FabContainer_Factory(t) { return new (t || FabContainer)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Platform)); };
FabContainer.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: FabContainer, selectors: [["ion-fab"]], contentQueries: function FabContainer_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, FabButton, 5);
        ɵngcc0.ɵɵcontentQuery(dirIndex, FabList, 4);
    } if (rf & 2) {
        let _t;
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FabContainer, [{
        type: Component,
        args: [{
                selector: 'ion-fab',
                template: '<ng-content></ng-content>'
            }]
    }], function () { return [{ type: ɵngcc1.Platform }]; }, { _mainButton: [{
            type: ContentChild,
            args: [FabButton]
        }], _fabLists: [{
