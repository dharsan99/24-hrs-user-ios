...
FabList.ɵfac = function FabList_Factory(t) { return new (t || FabList)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.Platform)); };
FabList.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: FabList, selectors: [["ion-fab-list"]], contentQueries: function FabList_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, FabButton, 4);
    } if (rf & 2) {
        let _t;
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FabList, [{
        type: Directive,
        args: [{
                selector: 'ion-fab-list'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: Renderer }, { type: ɵngcc1.Config }, { type: ɵngcc2.Platform }]; }, { _setbuttons: [{
