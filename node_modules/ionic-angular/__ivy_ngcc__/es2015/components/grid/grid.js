...
Grid.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: Grid, selectors: [["ion-grid"], ["", "ion-grid", ""]], hostAttrs: [1, "grid"] });
/**
 * @nocollapse
 */
Grid.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(Grid, [{
        type: Directive,
        args: [{
