...
Spinner.ɵfac = function Spinner_Factory(t) { return new (t || Spinner)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
Spinner.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: Spinner, selectors: [["ion-spinner"]], hostVars: 2, hostBindings: function Spinner_HostBindings(rf, ctx) { if (rf & 2) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(Spinner, [{
    ...
    }], function () { return [{ type: ɵngcc1.Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }]; }, { name: [{
            type: Input
        }], duration: [{
            type: Input
        }], paused: [{
