...
import * as ɵngcc2 from '../content/content';
...
Img.ɵfac = function Img_Factory(t) { return new (t || Img)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.Content, 8), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.DomController)); };
Img.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: Img, selectors: [["ion-img"]], inputs: { alt: "alt", src: "src", bounds: "bounds", cache: "cache", width: "width", height: "height" }, decls: 1, vars: 0, template: function Img_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(Img, [{
        type: Component,
        args: [{
                selector: 'ion-img',
                template: '<img>',
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: Renderer }, { type: ɵngcc1.Platform }, { type: ɵngcc2.Content, decorators: [{
                type: Optional
            }] }, { type: ɵngcc3.DomController }]; }, { alt: [{
            type: Input
        }], src: [{
            type: Input
        }], bounds: [{
