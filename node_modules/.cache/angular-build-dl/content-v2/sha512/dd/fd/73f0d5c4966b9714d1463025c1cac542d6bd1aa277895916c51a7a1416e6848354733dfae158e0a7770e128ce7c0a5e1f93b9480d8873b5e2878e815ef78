(function () {
  ...
  (self["webpackChunkuserapp"] = self["webpackChunkuserapp"] || []).push([["src_app_myprofile_myprofile_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        ...
        _createClass(MyprofilePage, [{
          ...
          value: function getSelectCategory() {
            ...
            this.http.get('/store_category').subscribe(function (response) {
              _this4.getCategoryList = response.records;
              console.log(response);
            }, function (error) {
              console.log(error);
            });
      ...
      _MyprofilePage = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
